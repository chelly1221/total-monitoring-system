...
항공기상청 [낙뢰 화면](https://global.amo.go.kr/weatherImage/lightning-stroke.do)이 사용하는 공개 웹 자료를 기본 3분마다 조회합니다. API 키나 로그인이 필요하지 않습니다. WING과 같은 김포공항 기준 좌표(37.56, 126.8)에서 반경 5km 이내의 지상낙뢰만 판정하며, 공중낙뢰는 제외합니다. 발생 시각은 UTC에서 한국 시각으로 표시하고 최근 24시간 이력을 유지합니다.
