// Package the portable distribution: src-tauri/target/release/tms-ups-monitor.zip holding the exe
...
const EXE = 'tms-ups-monitor.exe';
const RUNTIME = 'webview2';
const ZIP = path.join(RELEASE, 'tms-ups-monitor.zip');
